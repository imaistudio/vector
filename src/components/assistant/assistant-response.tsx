    ...
    return (
      <Streamdown
        className={cn(
          ...
          '[&_table]:my-2 [&_table]:block [&_table]:w-full [&_table]:border-collapse [&_table]:overflow-x-auto',
          '[&_th]:border-border [&_th]:bg-muted/40 [&_th]:border [&_th]:px-2 [&_th]:py-1 [&_th]:text-left [&_th]:text-xs [&_th]:whitespace-nowrap',
          '[&_td]:border-border [&_td]:border [&_td]:px-2 [&_td]:py-1 [&_td]:text-xs',
